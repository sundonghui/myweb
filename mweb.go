...
type (
	...
	// Context is the most important part of gem. It allows us to pass variables between middleware,
...
func New() *Engine {
	...
	engine.router.NotFound = &engine.handlers404
	return engine
}
...
func (group *RouterGroup) Handle(method, p string, handlers []HandlerFunc) {
	...
	handlers = group.combineHandlers(handlers)
	group.engine.router.Handle(method, p, func(w http.ResponseWriter, req *http.Request, params Params) {
...
func (c *HandlersChain) ServeHTTP(w http.ResponseWriter, req *http.Request) {
